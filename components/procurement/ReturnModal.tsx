  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        toast.error(data.message || "Failed to record return. Please verify all fields are filled correctly.");
      }
    } catch (error: any) {
      toast.error(error?.message || "A network or server error occurred while recording the return. Please try again.");
    } finally {
      setLoading(false);
    }
  };
